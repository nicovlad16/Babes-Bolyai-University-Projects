...
public class ControllerInterpreter
{
    ...
    public ControllerInterpreter(RepositoryInterface repository)
    {
    ...
    public List<ProgramState> oneStepForAllPrograms(List<ProgramState> programList) throws InterruptedException
    {
    ...
    public ProgramState getProgramStateByID(int index)
    {
        return repository.getProgramStateByID(index);
    }
}