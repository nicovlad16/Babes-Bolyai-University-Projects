...
public class Main
{
    private static Controller createController(StatementInterface statementInterface, String logFilePath)
...
//            example 6 - lab 6 - example1
            ...
            Controller controller6 = createController(ex6, "logFiles/log6.out");
...
//            example 7 - lab 6 - example2
            ...
            Controller controller7 = createController(ex7, "logFiles/log7.out");
...
//            example 8 - lab 6 - example3
            ...
            Controller controller8 = createController(ex8, "logFiles/log8.out");
...
//            example 9 - lab 7 - example 1
            StatementInterface ex9 = new PrintStatement(new ArithmeticExpression(new ConstantExpression(10),
                    ...
                    '+'));
            Controller controller9 = createController(ex9, "logFiles/log9.out");
...
//            example 10 - lab 7 - example 2
            StatementInterface ex10 = new PrintStatement(new BooleanExpression(new ArithmeticExpression(new ConstantExpression(10), new ConstantExpression(2), '+'),
                    ...
                    "<"));
            Controller controller10 = createController(ex10, "logFiles/log10.out");
...
//            example 11 - lab 7 - example 3
            StatementInterface ex11 = new CompoundStatement(new AssignStatement("v", new ConstantExpression(6)),
                    new CompoundStatement(new WhileStatement(new ArithmeticExpression(new VariableExpression("v"), new ConstantExpression(4), '-'),
                            ...
                            new PrintStatement(new VariableExpression("v"))));
            Controller controller11 = createController(ex11, "logFiles/log11.out");
...
//            example 12 - lab 8
            ...
            Controller controller12 = createController(ex12, "logFiles/log12.out");
...
//            example 13
            ...
            Controller controller13 = createController(ex13, "logFiles/log13.out");
...
//            example 14
            ...
            Controller controller14 = createController(ex14, "logFiles/log14.out");
