...
import domain.statement.Other.ForkStatement;
import domain.statement.Other.PrintStatement;
import repository.RepositoryException;
import view.ExitCommand;
import view.RunExample;
import view.TextMenu;

import static gui.SelectFormController.createControllerInterpreter;
...
public class MainConsole
{
    ...
    {
        return createControllerInterpreter(statementInterface, logFilePath);
    }
...
//            example 8 - lab 6 - example3
            StatementInterface comp9 = new CompoundStatement(new CompoundStatement(new AssignStatement("v", new ConstantExpression(10)),
                    new NewHeapStatement("v", new ConstantExpression(20))),
                    new NewHeapStatement("a", new ConstantExpression(22)));
            StatementInterface comp10 = new CompoundStatement(new CompoundStatement(new WriteHeapStatement("a", new ConstantExpression(30)),
...
//            example 12 - lab 8
            StatementInterface comp11 = new CompoundStatement(new CompoundStatement(new AssignStatement("v", new ConstantExpression(10)),
                    new NewHeapStatement("a", new ConstantExpression(22))),
                    new ForkStatement(new CompoundStatement(new CompoundStatement(new WriteHeapStatement("a", new ConstantExpression(30)),
